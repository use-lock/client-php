...
namespace Lock\Client\OpenApi\Management;

use GuzzleHttp\Psr7\Utils;
use Lock\Client\OpenApi\Management\Model\ModelInterface;
    ...
    public static function sanitizeForSerialization($data, $type = null, $format = null)
    {
        ...
        if (is_object($data)) {
            ...
            if ($data instanceof ModelInterface) {
                foreach ($data->getAdditionalProperties() as $property => $value) {
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Lock\Client\OpenApi\Management\Model\\' . $data->{$discriminator};
            ...
            if ($instance::allowsAdditionalProperties()) {
                foreach ((array) $data as $property => $value) {
                    if (!in_array($property, $instance::attributeMap(), true)) {
