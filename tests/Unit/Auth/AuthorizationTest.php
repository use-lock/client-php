...
beforeEach(function () {
    ...
    $this->authorization = function (array $responses = []) {
        $realm = new Realm('https://id.example.com', 'client-123', 'the-secret', 'https://app.example.com/callback', http: jsonClient($responses, $this->history));

        return $realm->authorization();
    };
